<x-admin-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="{{ route('gallery.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white font-medium py-2 px-4 rounded-lg inline-flex items-center transition duration-150 ease-in-out">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <form action="{{ route('gallery.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div>
                                    ...
                                    <select class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('category') border-red-500 @enderror"
                                            id="category"
                                            name="category"
                                            required>
                            ...
                            <div class="mb-6">
                                ...
                                <input type="file"
                                       ...
                                       accept="image/*"
                                       required>
                                <p class="mt-1 text-sm text-gray-500">Select multiple images (max 5MB each)</p>
                                @error('images')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
            ...
            <div class="space-y-6">
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <h3 class="text-lg font-semibold text-gray-900">Gallery Categories</h3>
                    </div>
                    <div class="p-6">
                        <ul class="space-y-3">
                            @foreach($categories as $key => $label)
                    ...
                    <div class="p-6">
                        <ul class="space-y-2 text-sm text-gray-600">
                            <li class="flex items-start">
                                ...
                                Use descriptive titles for galleries
                            </li>
                            <li class="flex items-start">
                                <i class="fas fa-lightbulb text-yellow-500 mr-2 mt-0.5"></i>
