...
<head>
    ...
    <style>
     ...
     .triumph-gradient {
        ...
        .anxiety-card::before { background: linear-gradient(90deg, #8b5cf6, #a78bfa); }
        .depression-card::before { background: linear-gradient(90deg, #3b82f6, #60a5fa); }
        .grief-card::before { background: linear-gradient(90deg, #10b981, #34d399); }
        .addiction-card::before { background: linear-gradient(90deg, #f59e0b, #fbbf24); }
        .trauma-card::before { background: linear-gradient(90deg, #ef4444, #f87171); }
        .wellness-card::before { background: linear-gradient(90deg, #06b6d4, #22d3ee); }
        .testimonial-slide {
            opacity: 0;
                     ...
                     <div>
                         ...
                         <ul class="space-y-3">
                             <li><a href="index.html#contact"
                                     class="text-gray-400 hover:text-white transition">Volunteer</a></li>
